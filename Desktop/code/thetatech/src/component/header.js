        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              ...
              <img
                className="h-8 w-auto font-bold text-red-500"
                src="./logo2.png"
                alt=""
              />
            </a>
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <ScrollIntoView
                selector={item.id}
                key={item.name}
                className="text-md font-semibold leading-6 text-gray-900 cursor-pointer hover:text-black"
              >
                {item.name}
              </ScrollIntoView>
            ))}
